...
from blart_architecture import BLARTNetworkGraph, blart_grid, blart_two_tokyo
from qiskit import QuantumCircuit
from convert import from_qiskit
import qiskit.qasm2

qc = qiskit.qasm2.load("./data/telesabre/qasm_25/ae_nativegates_ibm_qiskit_opt3_25.qasm")
